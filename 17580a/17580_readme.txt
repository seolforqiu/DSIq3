...
Complete Data Set contains 133 columns, 154 rows, and 1 segment(s).
...
This data set includes analytical results for measurements of VOCs (volatile
organic compounds) in 145 blood samples. These samples were collected to examine
the relationships between personal exposure measurements, environmental
measurements, and body burden. Venous blood samples were collected by
venipuncture by a health care worker. Samples were collected in vacutainers
pre-cleaned by the Centers for Disease Control (CDC). Whole blood samples were
refrigerated and shipped cold to the laboratory for analysis. Collected VOCs
were analyzed by gas chromatography/high resolution mass spectrometry in the
selected ion monitoring mode (GC/MS-SIM). Samples were collected and analyzed
using procedures based on CDC methods described in the CDC Compendium of Method
Summaries for Collection and Analysis of Metals and VOCs in Blood and Urine.
Keywords: VOCs; biomarkers.
