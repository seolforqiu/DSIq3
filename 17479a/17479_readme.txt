...
Complete Data Set contains 115 columns, 1010 rows, and 1 segment(s).
...
organic compounds) in 998 air samples. Samples of personal air, indoor air, and
outdoor air were collected using two-stage passive badges (3-M, 3520,
Minneapolis, MN) over a period of approximately 144 hours to measure selected
VOCs. A second badge was used for a subset of participants to assess the
contribution of occupational exposure to the total inhalation exposure. These
badges were also used inside of all homes (in the main living area), and outside
of a subset of homes. Collected VOCs were solvent extracted and analyzed by gas
chromatography/mass spectrometry (GC/MS) in the selected ion monitoring (SIM)
mode. Keywords: VOCs; air.Should we include the reference to the SOP #s here?
